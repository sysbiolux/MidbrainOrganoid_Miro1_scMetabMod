...
% celltype 1-5: 'GABAergic neurons';'Neurons';'Neural progenitors';'Dopaminergic neurons';'Astrocyte-like glia progenitors'
% 6: sum over all cell types
celltypeNr=5
...
for counterP=1:numel(nrPathways)
    ...
    disp(metList)
    disp('Rows:Model1-6; Columns:cluster1-5 + sum(1-5)')
    ...
    if plotPerPathway
        ...
        plotRes=reshape(resAllMets(:,celltypeNr,:),size(resAllMets,1),size(resAllMets,3))
        if exist('plotCutoff')
            plotCutoff
        ...
        switch celltypeNr
            case 1
                sgtitle('GABAergic neurons','fontweight','bold','fontsize',14)
            case 2
                sgtitle('Neurons','fontweight','bold','fontsize',14)
            case 3
                sgtitle('Neural progenitors','fontweight','bold','fontsize',14)
            case 4
                sgtitle('Dopaminergic neurons','fontweight','bold','fontsize',14)
            case 5
                sgtitle('Astrocyte-like glia progenitors','fontweight','bold','fontsize',14)
            case 6
                sgtitle('Sum over all cell types','fontweight','bold','fontsize',14)
        end
